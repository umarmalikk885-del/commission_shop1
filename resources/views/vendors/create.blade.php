...
<head>
    <meta charset="UTF-8">
    <title>وینڈر شامل کریں - کمیشن شاپ</title>
    ...
    <div class="card">
        ...
        <form action="/vendors" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="mobile" name="mobile" value="{{ old('mobile') }}" required autocomplete="tel">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="address" name="address" autocomplete="street-address">{{ old('address') }}</textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <select id="status" name="status" required autocomplete="off">
                    ...
                    <option value="blocked" {{ old('status') == 'blocked' ? 'selected' : '' }}>بلاک</option>
                </select>
            </div>

            <div class="form-group">
                <label for="commission_rate">کمیشن شرح (%) <span class="required">*</span></label>
                <input type="number" id="commission_rate" name="commission_rate" step="0.01" min="0" max="100" value="{{ old('commission_rate', 0) }}" required autocomplete="off">
            </div>

            <div>
                <button type="submit" class="btn">وینڈر محفوظ کریں</button>
