...
<head>
    <meta charset="UTF-8">
    <title>{{ __('شخص شامل کریں') }} | کمیشن شاپ</title>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">{{ __('نیا شخص شامل کریں') }}</h5>
                        </div>
                        <div class="card-body">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (form) {
                form.addEventListener('submit', function(e) {
                    ...
                    // Show loading
                    Swal.fire({
                        title: 'بنایا جا رہا ہے...',
                        text: 'براہ کرم انتظار کریں جب تک ہم تاجر کا ریکارڈ بنا رہے ہیں۔',
                    ...
                    .catch(error => {
                        ...
                        let errorText = 'تاجر بنانے میں ناکام۔ براہ کرم دوبارہ کوشش کریں۔';
